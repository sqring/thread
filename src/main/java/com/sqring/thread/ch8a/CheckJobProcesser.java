package com.sqring.thread.ch8a;

import com.sqring.thread.ch5.bq.ItemVo;
import com.sqring.thread.ch8a.vo.JobInfo;

import java.util.Map;
import java.util.concurrent.DelayQueue;

/**
 * 描述: 任务完成后,在一定的时间供查询结果，
 *      之后为释放资源节约内存，需要定期处理过期的任务
 *
 * @author www.zhouwenfang.com
 * @version 1.0
 * @date 2021/06/15 23:18:56
 */
